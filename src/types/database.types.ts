...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      prepare_job_offer: {
        Args: {
          p_additional_compensation?: string
          p_application_id: string
          p_benefits?: string
          p_notes?: string
          p_proposed_salary: number
          p_salary_grade_id: string
          p_start_date: string
          p_work_schedule_id: string
        }
        Returns: string
      ...
      record_contract_signing: {
        Args: { p_contract_id: string; p_file_path: string; p_signing_notes?: string }
        Returns: undefined
      }
